...
- [x] Brief 013 queue pass: mobile foundation added viewport-fit/safe-area handling, a shared 768px breakpoint, tested Job/Map/BOM bottom tabs, one-pane mobile pane visibility, and a sticky mobile header menu while preserving desktop layout behaviour.
