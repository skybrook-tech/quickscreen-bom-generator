...
- **Always update `docs/tasks.md` after completing any task or group of tasks.** Tick off completed items with `[x]`, update the Phases Overview table statuses, and update the "Current Phase" header to reflect the active phase. Do this before responding to the user, not as an afterthought.
