...
export function SystemInstancesListPage() {
  ...
  // Admin-only surface (mounted under AdminGuard), so isAdmin is always true here;
  // the gates below stay as defensive UI guards. The fork's supplier-portal
  // "supplier_staff" self-scoping path is intentionally dropped — that role/portal
  // concept is on the salvage kill list and not part of main's model.
