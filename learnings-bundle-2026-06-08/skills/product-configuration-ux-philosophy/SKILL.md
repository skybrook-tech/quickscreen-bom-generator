...
> UX philosophy for product configurators: smart defaults over empty forms, multi-option suggestions over open-ended questions, progressive disclosure over everything-at-once. Extracted from iterating on a tradie calculator with real user testing.
