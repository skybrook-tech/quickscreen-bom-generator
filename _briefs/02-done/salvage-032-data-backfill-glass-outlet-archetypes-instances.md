> **Salvage paper trail.** Ported from fork brief 033 as part of SALVAGE-PLAN Phase A.
> The corresponding migration was renumbered for the main repo to `supabase/migrations/032_backfill_glass_outlet_supplier_and_instances.sql`.
