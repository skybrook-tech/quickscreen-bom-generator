---
skill: supplier-catalogue-extractor
id: cmppk01c106nf07adcm2fitze
description: Methodology for extracting Australian fencing supplier catalogues (PDFs, brochures, build-packs) into calculator-ready structured data — products, SKUs, dimensions, finishes, accessories, dependencies, formulas, compatibility rules, and open questions. Complements bunnings-fence-scraper by handling any non-Bunnings supplier source.
whenToUse: 
tags: 
---
