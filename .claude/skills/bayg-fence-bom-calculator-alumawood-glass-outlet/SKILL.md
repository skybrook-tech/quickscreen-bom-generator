---
name: BAYG Fence BOM Calculator with Alumawood (Glass Outlet)
...
# BAYG Fence BOM Calculator with Alumawood (Glass Outlet)

> Self-contained BOM calculator spec for The Glass Outlet's BAYG (Buy As You Go) fence system, including Alumawood-finish variant: individual spacer SKUs (not 50-packs), 3000mm panels, explicit panel_quantity input, zero engine-emitted posts. Same extrusions as QSHS but per-panel retail model.
