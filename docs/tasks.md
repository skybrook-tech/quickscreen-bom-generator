...
Latest Brief 008 pass: section-level Post size, mounting, and spacing controls now have an explicit post-field allowlist, preventing slat range, slat colour, or post colour controls from appearing in the post dropdown while keeping legacy variables untouched.
