...
description: Architecture patterns for building SaaS calculators and BOM generators for trade industries. Covers 3-layer schema, run/section/gate hierarchy, BOM dispatch taxonomy, pricing models, and data model decisions.
---
