...
- [x] Brief H - Unified colour picker: colour and post-colour controls now share a reusable circular swatch picker with short codes, checkmark selected state, full-name hover tooltip, limited-stock dashed styling, and post colour hidden behind a contrasting-post toggle.
