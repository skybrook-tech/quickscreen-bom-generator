...
# VS Fence BOM Calculator (Glass Outlet)

> Self-contained BOM calculator spec for The Glass Outlet's VS (Vertical Slat) fence system: same extrusions as QSHS rotated 90 degrees, U-channel rails, panel-width-driven slat count, dedicated code path. Includes schema, attributes, BOM math, SKU patterns, worked example, and gotchas.
