...
- [x] Brief 012 queue pass: Print Map now renders a clean landscape printable map with 10% padded drawn-content framing, address/job/date metadata, customer-safe run/section summaries, and mobile native image sharing fallback.
