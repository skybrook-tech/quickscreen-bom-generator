...
pinned: false
tags: [hyperframes, website, conversion, video]
---

# website-to-hyperframes

> Convert a website's content into a HyperFrames video composition.

## When to use
When the user wants to turn a webpage, blog post, or article into a video — extract the content and structure it as a composition.
...
## Scripts
None (this platform skill references a multi-file `references/` tree that is part of the built-in skill and was not separately exported)
