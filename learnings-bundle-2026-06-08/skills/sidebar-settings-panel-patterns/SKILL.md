...
> Reusable UX patterns for sidebar settings panels with disclosure rows, auto-collapse, match indicators, and hierarchical card layouts. Extracted from building a production calculator with run/section/gate settings parity.
