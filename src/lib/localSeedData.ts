...
const syntheticComponents: SeedComponent[] = [
  ...
  ...[
    ...
    ["XP-HDL-KNOB", "XPRESS Screening Stanley round knob set", 57.2],
    ["XP-HDL-LEVER", "XPRESS Screening Stanley lever handle set", 82.16],
    ["XP-HDL-LW534", "XPRESS Screening Lockwood 534 round knob set", 199.68],
...
const syntheticPricingRules: LocalPricingRule[] = [
  ...
  ...[
    ...
    ["XP-HDL-KNOB", 57.2, 51.47, 48.77],
    ["XP-HDL-LEVER", 82.16, 74.34, 70.44],
    ["XP-HDL-LW534", 199.68, 181.85, 172.29],
