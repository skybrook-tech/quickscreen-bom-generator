...
Latest brief queue pass: Brief 003 applies roadmap-only Static Maps styling that keeps parcel boundaries emphasized while hiding business, POI, park, school, medical, worship, sports, and transit markers from captured roadmap layers.
